...
// _data.create('test', 'keka1994', {'foo':'bar'}, function(err){
// 	debug('this was the error: ', err);
// });

// _data.read('users', '0200005000', function(err, data){
// 	debug('this was the error: ', err ,'and this was the data :', data);
// })

// _data.delete('test', 'newFile', function(err){
// 	debug('this was the err', err);
// });

// @TODO get rid of this
// helpers.sendTwilioSms('270763890', 'Hello', function(err){
// 	debug('this was the error ', err);
// });
...
server.init = function(){
    ...
    server.httpServer.listen(config.httpPort, function(){
		debug('\x1b[36m%s\x1b[0m', 'The server is listening on port '+ config.httpPort);
    ...
    server.httpsServer.listen(config.httpsPort, function(){
		debug('\x1b[35m%s\x1b[0m', 'The server is listening on port '+ config.httpsPort);
