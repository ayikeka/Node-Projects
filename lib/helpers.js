...
// Create a string length of alphanumeric characters, of a given length
...
// Add the universal header and footer to a string, and pass a provided data object to the header and footer for interpolaion
...
helpers.getStaticAsset = function(fileName, callback){
    ...
    if(fileName){
        ...
        callback('A valid file name was not spicified');
    }
}
